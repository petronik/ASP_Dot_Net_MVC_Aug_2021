...
namespace ASP_Dot_Net_MVC_Aug_2021.Data.MockRepo
{
    public class MockProductRepo : IProductRepo
    {
        private readonly static List<Product> _products = new List<Product> {
            new Product { P_Code = "11GER/G1", P_descript = "Power painter, 15 psi., 3-nozzle", P_InDate = new DateTime(2017,11, 03, 02, 12, 30).Date, P_QOH = 8  , P_Min = 5         , P_Price = 109.99  , P_Discount = 0    , V_code = 25595 },
